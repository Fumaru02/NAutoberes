                    ...
                    child: ResponsiveRowColumn(
                      ...
                      children: <ResponsiveRowColumnItem>[
                        ResponsiveRowColumnItem(
                          ...
                          children: <ResponsiveRowColumnItem>[
                            ...
                            ResponsiveRowColumnItem(
                                child: IconButton(
                              onPressed: () =>
                                  homeServicesController.hideHomeServices(),
                              icon: Icon(
                                Icons.close_sharp,
                        ...
                        ResponsiveRowColumnItem(
                          ...
                          rowMainAxisAlignment: MainAxisAlignment.center,
                          children: <ResponsiveRowColumnItem>[
                            const ResponsiveRowColumnItem(child: Icon(Icons.call)),
                            ResponsiveRowColumnItem(
                              child: RobotoTextView(
                                value: 'Contact Person 0812-1232-2232',
                                color: AppColors.black,
            ...
            child: Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) =>
                    CustomRippleButton(
                  onTap: () => homeServicesController.showHomeServices(),
                  child: Container(
